    ...
    <div class="ps-awards">
      ...
      <div class="ps-block--signature">
        ...
        <div class="ps-block__content">
          <p>“It seems that every country that can get its hands on butter has its opinion of what butter cream frosting should be. Some are made with eggs and butter.”</p><small>La Caverne a gouter</small><img src="images/signature-2.png" alt="">
        </div>
      </div>
    </div>
    <!-- Home 1 products-->
    <div class="ps-home-product bg--cover" data-background="images/bg/home-product.jpg">
      <div class="ps-container">
        <div class="ps-section__header">
          ...
          <p>Cupcakes every day</p><span><img src="images/icons/floral.png" alt=""></span>
        </div>
        <div class="ps-section__content">
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ">
              <div class="ps-product ps-product--horizontal">
                <div class="ps-product__thumbnail"><span class="ps-badge"><img src="images/icons/badge-red.png" alt=""><i>New</i></span><img src="images/products/1.jpg" alt=""><a class="ps-product__overlay" href="product-detail.php"></a>
                  <ul class="ps-product__actions">
                    <li><a href="product-detail.php" data-tooltip="Quick View"><i class="ba-magnifying-glass"></i></a></li>
                    <li><a href="#" data-tooltip="Favorite"><i class="ba-heart"></i></a></li>
                    <li><a href="#" data-tooltip="Add to Cart"><i class="ba-shopping"></i></a></li>
                  </ul>
                </div>
                <div class="ps-product__content"><a class="ps-product__title" href="product-detail.php">Chessecake Fraise</a>
                  <p><a href="product-list.html">La caverne a goute</a> - <a href="product-list.html">Sweet</a> - <a href="product-list.html">Bio</a></p>
                  ...
                  <p class="ps-product__price">5dt</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ">
              <div class="ps-product ps-product--horizontal">
                <div class="ps-product__thumbnail"><span class="ps-badge"><img src="images/icons/badge-red.png" alt=""><i>New</i></span><img src="images/products/2.jpg" alt=""><a class="ps-product__overlay" href="product-detail.php"></a>
                  <ul class="ps-product__actions">
                    <li><a href="product-detail.php" data-tooltip="Quick View"><i class="ba-magnifying-glass"></i></a></li>
                    <li><a href="#" data-tooltip="Favorite"><i class="ba-heart"></i></a></li>
                    <li><a href="#" data-tooltip="Add to Cart"><i class="ba-shopping"></i></a></li>
                ...
                <div class="ps-product__content"><a class="ps-product__title" href="product-detail.php">Chesecake Speculoos</a>
                  <p><a href="product-list.html">La caverne a gouter</a> - <a href="product-list.html">Sweet</a> - <a href="product-list.html">Bio</a></p>
                  <select class="ps-rating">
                    <option value="1">1</option>
                    <option value="1">2</option>
                    <option value="1">3</option>
                  ...
                  <p class="ps-product__price">5 dt</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ">
              <div class="ps-product ps-product--horizontal">
                <div class="ps-product__thumbnail"><span class="ps-badge"><img src="images/icons/badge-red.png" alt=""><i>New</i></span><img src="images/products/4.jpg" alt=""><a class="ps-product__overlay" href="product-detail.php"></a>
                  <ul class="ps-product__actions">
                ...
                <div class="ps-product__content"><a class="ps-product__title" href="product-detail.php">Chocolat Chaud</a>
                  <p><a href="product-list.html">La Caverne à goutery</a> - <a href="product-list.html">Sweet</a> - <a href="product-list.html">Bio</a></p>
                  <select class="ps-rating">
                    <option value="1">1</option>
                    <option value="1">2</option>
                    <option value="1">3</option>
                  ...
                  <p class="ps-product__price">4 dt</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ">
              <div class="ps-product ps-product--horizontal">
                <div class="ps-product__thumbnail"><span class="ps-badge ps-badge--sale"><img src="images/icons/badge-brown.png" alt=""><i>50%</i></span><img src="images/products/3.jpg" alt=""><a class="ps-product__overlay" href="product-detail.php"></a>
                  <ul class="ps-product__actions">
                    <li><a href="#" data-tooltip="Quick View"><i class="ba-magnifying-glass"></i></a></li>
                    <li><a href="#" data-tooltip="Favorite"><i class="ba-heart"></i></a></li>
                    <li><a href="#" data-tooltip="Add to Cart"><i class="ba-shopping"></i></a></li>
                ...
                <div class="ps-product__content"><a class="ps-product__title" href="product-detail.php">Chessecake Citron</a>
                  ...
                  <p class="ps-product__price"><del>7.5 dt</del> 4 dt</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ">
              <div class="ps-product ps-product--horizontal">
                <div class="ps-product__thumbnail"><span class="ps-badge"><img src="images/icons/badge-red.png" alt=""><i>New</i></span><img src="images/products/5.jpeg" alt=""><a class="ps-product__overlay" href="product-detail.php"></a>
                  <ul class="ps-product__actions">
                    <li><a href="#" data-tooltip="Quick View"><i class="ba-magnifying-glass"></i></a></li>
                    <li><a href="#" data-tooltip="Favorite"><i class="ba-heart"></i></a></li>
                    <li><a href="#" data-tooltip="Add to Cart"><i class="ba-shopping"></i></a></li>
                ...
                <div class="ps-product__content"><a class="ps-product__title" href="product-detail.php">Beurre de cacahuète</a>
                  <p><a href="product-list.html">Bakery</a> - <a href="product-list.html">Sweet</a> - <a href="product-list.html">Bio</a></p>
                  <select class="ps-rating">
                    <option value="1">1</option>
                    <option value="1">2</option>
                  ...
                  <p class="ps-product__price">7 dt</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 ">
              <div class="ps-product ps-product--horizontal">
                <div class="ps-product__thumbnail"><span class="ps-badge ps-badge--sale"><img src="images/icons/badge-brown.png" alt=""><i>50%</i></span><img src="images/products/7.png" alt=""><a class="ps-product__overlay" href="product-detail.php"></a>
                  <ul class="ps-product__actions">
                    <li><a href="#" data-tooltip="Quick View"><i class="ba-magnifying-glass"></i></a></li>
                    <li><a href="#" data-tooltip="Favorite"><i class="ba-heart"></i></a></li>
                    <li><a href="#" data-tooltip="Add to Cart"><i class="ba-shopping"></i></a></li>
                ...
                <div class="ps-product__content"><a class="ps-product__title" href="product-detail.php">Gateaux Chocolat</a>
                  <p><a href="product-list.html">Bakery</a> - <a href="product-list.html">Sweet</a> - <a href="product-list.html">Bio</a></p>
                  <select class="ps-rating">
                    <option value="1">1</option>
                    <option value="1">2</option>
                  ...
                  <p class="ps-product__price"><del>80 dt</del> 70 dt</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="ps-carousel--testimonial owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="off" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut">
          <div class="ps-block--tesimonial">
            ...
            <div class="ps-block__footer">
              <p><strong>Salwa Ben Saleh</strong>- Founder -</p>
            </div>
          </div>
          <div class="ps-block--tesimonial">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
              <div class="ps-post">
                ...
                <div class="ps-post__content"><span class="ps-post__posted">March 31, 2018</span><a class="ps-post__title" href="#">BUTTERY TOAST</a><span class="ps-post__byline">By<a href="#"> La caverne a gouter</a></span>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
              <div class="ps-post">
                ...
                <div class="ps-post__content"><span class="ps-post__posted">March 31, 2018</span><a class="ps-post__title" href="#">Pumpkin buns with salted</a><span class="ps-post__byline">By<a href="#">La caverne a gouter</a></span>
                  <p>Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further…</p><a class="ps-post__morelink" href="blog-detail.html">Read more</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
              <div class="ps-post">
                ...
                <div class="ps-post__content"><span class="ps-post__posted">March 31, 2018</span><a class="ps-post__title" href="#">Tartine style bread</a><span class="ps-post__byline">By<a href="#"> La caverne a gouter</a></span>
                  <p>Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further…</p><a class="ps-post__morelink" href="blog-detail.html">Read more</a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
            <div class="ps-block__content">
              <div class="ps-block--contact">
                <h4>Store in Bardo</h4>
              
                <p><i class="fa fa-envelope"></i><a href="mailto:helo@bredy.com">hello@lacave.com</a></p>
                <p><i class="fa fa-phone-square"></i>+216 58566444</p>
              </div>
              <div class="ps-block--contact">
                <h4>Store in Marsa</h4>
             
                <p><i class="fa fa-envelope"></i><a href="mailto:helo@bredy.com">hello@lacave.com</a></p>
                <p><i class="fa fa-phone-square"></i>+216 58566444</p>
              </div>
              <div class="ps-block--contact">
                <h4>Store in Menzah</h4>
               
                <p><i class="fa fa-envelope"></i><a href="mailto:helo@bredy.com">hello@lacavess.com</a></p>
                <p><i class="fa fa-phone-square"></i>+216 58566444</p>
              </div>
            </div>
          </div>
        ...
        <div class="ps-container">
          <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 ">
              <div class="ps-site-info"><a class="ps-logo" href="index.php"><img src="" alt=""></a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 ">
              <form class="ps-form--subscribe-offer" action="http://warethemes.com/html/laCave/do_action" method="post">
                <h4>Recevez nos nouveautés & offres</h4>
                <div class="form-group">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 ">
              <div class="ps-footer__open">
                ...
                <p>
                  Lundi - Samedi: <br>08:00 - 21:00 <br>
                </p>
              </div>
